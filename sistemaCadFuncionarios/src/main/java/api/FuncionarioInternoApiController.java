...
public class FuncionarioInternoApiController extends HttpServlet {
    ...
    private final RepositorioFuncionarioInternoImplementacao repositorio =
    ...
    protected void doPut(HttpServletRequest request, HttpServletResponse response)
        ...
        for (String param : body.split("&")) {
            ...
            if (kv.length == 2) {
                ...
                if ("matricula".equals(key)) matricula = value;
                if ("cargo".equals(key)) cargo = value;
                if ("salario".equals(key)) salario = value;
